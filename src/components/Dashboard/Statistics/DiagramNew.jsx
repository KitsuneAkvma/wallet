...
export const Diagram = () => {
  ...
  const [chosenMonth, setChosenMonth] = useState(new Date().toLocaleString('en-US', { month: 'long' }));
          ...
          <div className={styles.select}>
            ...
            <input className={styles.selectMonthInput} value={chosenMonth}/>
                ...
                {isMonthListOpen && (
                  ...
                  >
                    <li onClick={()=>{setChosenMonth("January")}} className={styles.optionLi} value="January">
                      January
                    </li>
                    <li onClick={()=>{setChosenMonth("February")}} className={styles.optionLi} value="February">
                      February
                    </li>
                    <li onClick={()=>{setChosenMonth("March")}} className={styles.optionLi} value="March">
                      March
                    </li>
                    <li onClick={()=>{setChosenMonth("April")}} className={styles.optionLi} value="April">
                      April
                    </li>
                    <li onClick={()=>{setChosenMonth("May")}} className={styles.optionLi} value="May">
                      May
                    </li>
                    <li onClick={()=>{setChosenMonth("June")}} className={styles.optionLi} value="June">
                      June
                    </li>
                    <li onClick={()=>{setChosenMonth("July")}} className={styles.optionLi} value="July">
                      July
                    </li>
                  </ul>
                )}
            ...
            <input className={styles.selectYearInput} value={chosenYear}/>
                ...
                {isYearListOpen && (
                  <ul
                    className={`${styles.optionList}`}
                  >
                    <li onClick={()=>{setChosenYear("2020")}} className={styles.optionLi} value="2020">
                      2020
                    </li>
                    <li onClick={()=>{setChosenYear("2021")}} className={styles.optionLi} value="2021">
                      2021
                    </li>
                    <li onClick={()=>{setChosenYear("2022")}} className={styles.optionLi} value="2022">
                      2022
                    </li>
                    <li onClick={()=>{setChosenYear("2023")}} className={styles.optionLi} value="2023">
                      2023
                    </li>
                  </ul>
                )}
